...
const data_FacultyProfile = ref({
    ...
    district: "",
    faculty_email: "",
    dual_language: false,  /// True if they are spanish or other language teacher with non-english kids, otherwise false to indicate they are english speaking teachers      
    school_name: "",
    department: "",
    phone_number: "",
    grade: ""
