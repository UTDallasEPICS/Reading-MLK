...
const data_FacultyProfile = ref({          
  school_dist: "",     
  dual_lang: null,      /// True if they are spanish or other language teacher with non-english kids, otherwise false to indicate they are english speaking teachers      
  faculty_email: "",  
  first_name: "",   
  last_name: "",    
  school_name: "",   
        ...
        div(class="")
            ...
            .py-4.grid(class="" )
                Label * Do you teach a dual language class?
                    select(v-model="data_FacultyProfile.dual_lang" name="dual_lang" id="dual_lang" class="block w-full rounded-md border border-gray-400 focus:border-gray-700"  placeholder = "(Do you Teach a Bilingual Class)")
