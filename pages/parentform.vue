...
div
    .flex.gap-5
        .flex.flex-col.gap-5.margin-auto(class="w-1/2 text-center")
            ...
            div(class="border border-gray-700 rounded-lg px-10")
                ...
                .py-4.grid(class="" )
                    Label Yearly Income:
                        select(v-model="data_StudentProfile.yearly_income"  name="yearly_income" id="yearly_income" class="block w-full rounded-md border border-gray-400 focus:border-gray-700" placeholder = "(Select your income level)")
                ...
                .py-4.grid(class="" )
                    Label What is your marital status?
                        select(v-model="data_StudentProfile.martial_status" name='marital_stat' id="marital_stat" class="block w-full rounded-md border border-gray-400 focus:border-gray-700" placeholder = "(Select your Marital Status)")
    ...
    .flex.gap-5(class="object-center py-2")
        Button.mx-auto.text-md(name="Submitt accounts" @click="submittAccounts()" class='bg-green-400 hover:bg-green-500 text-black rounded-lg px-2 py-2') Submit
</template>