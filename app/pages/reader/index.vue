        ...
        >
          <div class="flex items-center gap-3">
            ...
            <div class="flex-grow overflow-hidden">
              <p class="text-sm font-bold" style="color: var(--brand-dark); overflow-wrap: anywhere; word-break: break-word;">
                ...
                <span v-html="parseContent(mostRecent.content).title"></span>
              </p>
              <p class="text-xs text-gray-400 mt-0.5" style="overflow-wrap: anywhere; word-break: break-word;"><span v-html="parseContent(mostRecent.content).body"></span></p>
            </div>
            ...
            >
              ...
              <div class="flex-grow">
                <div class="flex flex-col gap-0.5 mb-2">
                  <h4 class="text-base font-bold text-gray-800" style="overflow-wrap: anywhere; word-break: break-word;"><span v-html="parseContent(ann.content).title"></span></h4>
                  <span class="text-[10px] font-bold uppercase tracking-wider text-gray-400">
                    {{ fmtDate(ann.postDate) }}{{ ann.expiryDate ? ' → ' + fmtDate(ann.expiryDate) : ' (Ongoing)' }}
                  </span>
                </div>
                <p class="text-sm text-gray-500 font-medium leading-relaxed" style="overflow-wrap: anywhere; word-break: break-word; max-width: 100%;"><span v-html="parseContent(ann.content).body"></span></p>
              </div>
            </div>
          </div>
        </div>
